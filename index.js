...
const prefix = '.';
const ownerNumber = ['94751883684']; // ඔයාගේ no එක දාන්න 🙄
...
async function connectToWhatsApp() {
    ...
    conn.ev.on('connection.update', (update) => {
        ...
        if (connection === 'close') {
           ...
           conn.newsletterFollow("120363423739477495@newsletter") // මේකට ඔයාගේ channel jid එක දාන්න
           console.log(" CHANNEL FOLLOW ✅")
           let up = `Xanz MD connected successful ✅\n\nPREFIX: ${prefix}`; // වෙනස් කරන්නහ්
           conn.sendMessage("94751883684@s.whatsapp.net", { image: { url: `https://i.ibb.co/5xzWmSxn/20250224-094453.png` }, caption: up }) // වෙනස් කරන්නහ්
...
if (mek.key && mek.key.remoteJid === 'status@broadcast' && config.AUTO_READ_STATUS === "true"){
      ...
      if (timeDiff <= maxTime) {
        ...
        try {
          ...
          let rep = `Status seen by Xanz MD 💙`; // වෙනස් කරගන්නන 
